...
Revision ID: 3413a37da20b
Revises:
Create Date: 2026-02-17 01:47:00.954766
...
def upgrade() -> None:
    ...
    op.add_column(
        "orders", sa.Column("discount_code", sa.String(length=50), nullable=True)
    )
